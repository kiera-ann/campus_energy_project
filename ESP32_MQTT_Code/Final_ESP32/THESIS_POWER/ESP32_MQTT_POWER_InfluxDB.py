''' Subscribes Power Sensor Data topic and parses data to InfluxDB.'''
...
MQTT_ADDRESS = "140.180.133.81"
MQTT_USER = 'admin'
MQTT_PASSWORD = 'admin'
MQTT_ESP32_POWER_SENSORS_TOPIC = 'dormhud/power'
...
# On connecting to MQTT Broker, Subscribe to topic from variable "MQTT_ESP32_POWER_SENSORS_TOPIC"
...
# Function to execute energy and energy carbon calculations
def calc_energy_co2_dorm(measurement_name) :
    # Ensure measurement data name is type string
    measurement_name = str(measurement_name)
    # Function to calculate energy calculations; returns pass or failed depending on timescale difference of last values
    dorm_energy_write_result = write_DR_energy_to_InfluxDB(measurement_name)
