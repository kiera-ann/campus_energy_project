...
def query_last_2_values_cogen_microturbine_InfluxDB() :
    ...
    # print(cogen_microturbine_query)   # Debugging print statement
...
def write_cogen_microturbine_energy_to_InfluxDB() :
    ...
    # print("PU Energy Data: Cogen MicroTurbine")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(write_cogen_microturbine_energy_to_InfluxDB())  # Debugging print statement
