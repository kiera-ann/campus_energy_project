...
# Debugging function
# print(influxdb_query_builder_aux_bioler_1_calc())      # Debugging print statement
...
def query_last_2_values_aux_bioler_1_dthr_InfluxDB() :
    ...
    # print(cogen_aux_bioler_1_dthr_query)   # Debugging print statement
...
def write_pu_cogen_aux_bioler_1_co2_to_InfluxDB() :
    ...
    # print("Dthr Cogen Auxiliary Bioler # 1")  # Debugging print statement
    ...
    # print("cogen_total_aux_bioler_1_pounds_co2")   # Debugging print statement
    # print(cogen_total_aux_bioler_1_pounds_co2)   # Debugging print statement
    ...
    # print("PU Heating: Auxiliary Bioler # 1")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(query_last_2_values_aux_bioler_1_dthr_InfluxDB())  # Debugging print statement
# print(write_pu_cogen_aux_bioler_1_co2_to_InfluxDB())  # Debugging print statement
