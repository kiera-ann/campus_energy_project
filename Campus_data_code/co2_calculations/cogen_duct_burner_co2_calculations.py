''' Function to calculate CO2 produced from Princeton Cogen Supplementary fired Duct Burner: EP.Cogen.DB.i.Gas_dthr. Writes to InfluxDB '''
...
def influxdb_query_builder_duct_burner_calc() :
    # Set data_field provided to function to variable "data_field_label_str"
    data_field_label_str = str("EP.Cogen.DB.i.Gas_dthr")
...
# Debugging function
# print(influxdb_query_builder_duct_burner_calc())      # Debugging print statement


# Function to query last 2 values
def query_last_2_values_duct_burner_dthr_InfluxDB() :
    # Generate Queries for Cogen duct_burner dthr data; only last 2 points will be used
    cogen_duct_burner_dthr_query = influxdb_query_builder_duct_burner_calc()
    # print(cogen_duct_burner_dthr_query)   # Debugging print statement

    query_str = str(cogen_duct_burner_dthr_query)  # convert query to type string
...
def write_pu_cogen_duct_burner_co2_to_InfluxDB() :
    ...
    dict_of_dthr_data = query_last_2_values_duct_burner_dthr_InfluxDB()  # Returns a dictionary of timestamp and values
    ...
    cogen_total_duct_burner_pounds_co2 = float((amount_nat_gas_btu / 1000000) * 117)
    cogen_total_duct_burner_pounds_co2 = round(float(cogen_total_duct_burner_pounds_co2) , 3)  # Unit pounds CO2
    # print("cogen_total_duct_burner_pounds_co2")   # Debugging print statement
    # print(cogen_total_duct_burner_pounds_co2)   # Debugging print statement

    # Puts data in json body for writing to InfluxDB
    json_body = [
        {
            'measurement' : "PU Heating: Duct Burner" ,
            'tags' : {
            ...
            "time" : last_timepoint ,
            'fields' : {
                'value' : cogen_total_duct_burner_pounds_co2 ,
            }
        }
    ]
    ...
    # print("PU Heating: Duct Burner")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(write_pu_cogen_duct_burner_co2_to_InfluxDB())  # Debugging print statement
