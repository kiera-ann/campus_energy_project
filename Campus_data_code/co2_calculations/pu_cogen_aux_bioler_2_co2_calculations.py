''' Function to calculate CO2 produced from Princeton Cogen Auxiliary Boiler # 2: EP.BLRS.02.i.GasFlow_dthr. Writes to InfluxDB '''
...
def influxdb_query_builder_aux_bioler_2_calc() :
    # Set data_field provided to function to variable "data_field_label_str"
    data_field_label_str = str("EP.BLRS.02.i.GasFlow_dthr")
...
# Debugging function
# print(influxdb_query_builder_aux_bioler_2_calc())      # Debugging print statement


# Function to query last 2 values
def query_last_2_values_aux_bioler_2_dthr_InfluxDB() :
    # Generate Queries for Cogen auxiliary bioler # 1 dthr data; only last 2 points will be used
    cogen_aux_bioler_2_dthr_query = influxdb_query_builder_aux_bioler_2_calc()
    # print(cogen_aux_bioler_2_dthr_query)   # Debugging print statement

    query_str = str(cogen_aux_bioler_2_dthr_query)  # convert query to type string
...
# Debugging function
# print(query_last_2_values_aux_bioler_2_dthr_InfluxDB())

# Function to write CO2 data from Auxiliary Bioler #2 to InfluxDB
def write_pu_cogen_aux_bioler_2_co2_to_InfluxDB() :
    # DTHR is shorthand for dekatherms per hour
    dict_of_dthr_data = { }  # Initialize dictionary

    # print("Dthr Cogen Auxiliary Bioler # 2")  # Debugging print statement
    dict_of_dthr_data = query_last_2_values_aux_bioler_2_dthr_InfluxDB()  # Returns a dictionary of timestamp and values
    ...
    cogen_total_aux_bioler_2_pounds_co2 = float((amount_nat_gas_btu / 1000000) * 117)
    cogen_total_aux_bioler_2_pounds_co2 = round(float(cogen_total_aux_bioler_2_pounds_co2) , 3)  # Unit pounds CO2
    # print("cogen_total_aux_bioler_2_pounds_co2")   # Debugging print statement
    # print(cogen_total_aux_bioler_2_pounds_co2)   # Debugging print statement

    # Puts data in json body for writing to InfluxDB
    json_body = [
        {
            'measurement' : "PU Heating: Auxiliary Bioler # 2" ,
            'tags' : {
            ...
            'fields' : {
                'value' : cogen_total_aux_bioler_2_pounds_co2 ,
            }
        }
    ]
    ...
    # print("PU Heating: Auxiliary Bioler # 2")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(query_last_2_values_aux_bioler_2_dthr_InfluxDB())  # Debugging print statement
print(write_pu_cogen_aux_bioler_2_co2_to_InfluxDB())  # Debugging print statement
