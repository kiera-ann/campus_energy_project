...
def query_last_2_values_cogen_total_steam_InfluxDB() :
    ...
    # print(cogen_total_steam_query)   # Debugging print statement
...
# Debugging function
# print(query_last_2_values_cogen_total_steam_InfluxDB()) # Debugging print statement
...
def write_cogen_total_steam_to_InfluxDB() :
    ...
    # print("PU Steam Data: Total Production")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(write_cogen_total_steam_to_InfluxDB())  # Debugging print statement
