''' Function to calculate most recent total pounds of CO2 for Princeton's Campus Heat and store data in InfluxDB. '''
import pandas as pd
...
# List of measurements of relevance to Campus CO2 for Heat
...
def influxdb_query_builder_heat_co2_lbs(meaurement_name) :
