...
def generate_list_of_queries() :
    ...
    for name in measurement_names_for_energy_co2 :
        # print(influxdb_query_builder_energy_co2_lbs(name))   # Debugging print statement
...
def write_recent_total_campus_energy_co2_to_InfluxDB() :
    ...
    # print("PU CO2 Data: Energy")  # Debugging print statement
    # print(json_body) # Debugging print statement


# Debugging function
# print(write_recent_total_campus_energy_co2_to_InfluxDB())  # Debugging print statement
