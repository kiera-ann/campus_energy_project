...
# list_of_sensor_names = ['ESP32_POWER_SENSOR: 7C:9E:BD:D8:C4:34',
#                         'ESP32_POWER_SENSOR: 7C:9E:BD:D7:4D:C0']

# list_of_sensor_names = ['ESP32_POWER_SENSOR: 7C:9E:BD:D7:4D:C0',
#                         'ESP32_POWER_SENSOR: 7C:9E:BD:D8:C4:34']
...
def query_influxdb_dorm_energy_data_u_a3() :
    # Initialize Variable
    total_kwh_today = 0.0
...
# Debugging function
# print(query_influxdb_dorm_energy_data_u_a3())          # Debugging print statement
