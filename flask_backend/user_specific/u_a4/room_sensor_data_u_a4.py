...
# get_sensor_data_u_a4
def get_sensor_data_u_a4() :
    data_dict = { }  # Initialize Dictionary
    building_name = 'Wendell Hall'
    room_number = 'B218'
    full_room_location = 'Wendell Hall - ROOM B218'
